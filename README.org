...
The subject can be found in the [[file:reference/project-self-test.pdf][project description]].
...
* References
** [[file:reference/self-testing-review.pdf][Self-testing of quantum systems: a review (1)]]
** [[file:reference/self-testing-apparatus.pdf][Self testing quantum apparatus (2)]]
** [[file:reference/bell-nonlocality][Bell nonlocality (3)]]
